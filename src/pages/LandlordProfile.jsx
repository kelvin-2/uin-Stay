      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="flex justify-between items-start">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-lg">UniStay Landlord</p>
          ...
          <div className="bg-white rounded-xl shadow-sm">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-blue-900 font-medium text-lg">{profile.full_name || 'Not provided'}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-blue-900 font-medium">{profile.email || 'Not provided'}</p>
                        )}
                      </div>
                    </div>
            ...
            {isEditing && (
              <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-xl mx-8 mb-8">
