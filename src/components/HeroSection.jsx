...
function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-24 md:py-32">
        <div className="backdrop-blur-sm bg-white/30 rounded-2xl sm:rounded-3xl shadow-xl border border-white/40 p-6 sm:p-12 md:p-16">
          <div className="text-center">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 inline-block text-transparent bg-clip-text relative">
                Port Elizabeth
                <svg className="absolute -bottom-1 sm:-bottom-2 left-0 w-full" height="8" viewBox="0 0 100 8" preserveAspectRatio="none">
            ...
            <p className="mt-6 sm:mt-8 text-base sm:text-lg leading-relaxed text-gray-600 max-w-[680px] mx-auto px-2" style={{ lineHeight: '1.7' }}>
            ...
            <div className="mt-8 sm:mt-10 flex items-center justify-center gap-x-6">
              <button 
                ...
                className="w-full sm:w-auto rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold text-white shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300"
            ...
            {/* Stats Section - Uncommented and mobile optimized */}
            {/* <div className="mt-12 sm:mt-16 grid grid-cols-2 gap-3 sm:gap-6 md:grid-cols-4 max-w-4xl mx-auto">
              {[
                ...
                <div 
                  key={index} 
                  className="flex flex-col items-center p-4 sm:p-6 rounded-xl sm:rounded-2xl backdrop-blur-sm bg-white/40 border border-white/50 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300"
                >
                  <stat.icon className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 mb-2" />
                  <div className="font-bold text-2xl sm:text-3xl text-gray-900">{stat.value}</div>
