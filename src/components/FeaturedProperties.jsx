...
import { 
  ...
  Star, ChevronLeft, ChevronRight, CreditCard, 
  GraduationCap, BadgeDollarSign, ImageOff, Sparkles
} from 'lucide-react';
...
function FeaturedProperties() {
    ...
    return (
      <div className="w-full px-4 md:px-0">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link 
            to="/properties" 
            className="px-4 py-2 rounded-xl bg-white/40 backdrop-blur-md border border-white/20 text-blue-600 hover:bg-white/60 font-medium flex items-center gap-2 transition-all duration-300 shadow-lg"
          >
            View all
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {[1, 2, 3, 4].map((index) => (
            <div key={index} className="backdrop-blur-xl bg-white/30 border border-white/20 rounded-3xl overflow-hidden animate-pulse shadow-2xl">
              <div className="h-48 sm:h-56 md:h-64 bg-gradient-to-br from-blue-200/50 to-purple-200/50" />
    ...
    return (
      <div className="w-full px-4 md:px-0">
        ...
        <div className="p-8 text-center">
          <div className="backdrop-blur-xl bg-red-50/70 border border-red-200/50 p-6 rounded-3xl inline-block shadow-2xl">
            <p className="text-red-600 font-medium">Error: {error}</p>
            <button 
              onClick={() => window.location.reload()} 
              className="mt-4 px-6 py-2 backdrop-blur-md bg-red-100/80 border border-red-200/50 text-red-700 rounded-xl hover:bg-red-200/80 transition-all duration-300 shadow-lg"
            >
              Retry
            </button>
          </div>
  ...
  return (
    <div className="w-full px-4 md:px-0">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-2xl backdrop-blur-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/30 shadow-xl">
        ...
        <Link 
          to="/properties" 
          className="px-5 py-2.5 rounded-xl backdrop-blur-xl bg-white/40 border border-white/30 text-blue-600 hover:bg-white/60 font-medium flex items-center gap-2 transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-0.5"
        >
      ...
      {properties.length > 0 ? (
        ...
        <div className="text-center py-12 rounded-3xl backdrop-blur-xl bg-gradient-to-br from-gray-50/70 to-gray-100/70 border border-white/30 shadow-2xl">
          ...
          <h3 className="text-lg font-bold text-gray-700 mb-2">No Properties Available</h3>
          <p className="text-sm text-gray-600 mb-6">We don't have any featured properties at the moment.</p>
          <button 
            onClick={() => window.location.reload()} 
